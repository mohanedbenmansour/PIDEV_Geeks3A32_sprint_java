...
public class Mailing {
    ...
    public Mailing() {
        con = Connector.getInstance().getCnx();
    ...
    public static void mailing(String recipient) throws Exception {
        ...
        final String moncompteEmail = "esprit.geeks@esprit.tn";
        final String psw = "geeks123geeks";
    ...
    public static void mailingValider(String recipient, String NomT) throws Exception {
        ...
        try {
            ...
            msg.setFrom(new InternetAddress(moncompteEmail));
            msg.setRecipient(Message.RecipientType.TO, new InternetAddress(recipient));
            msg.setSubject("Nouveau Tournoi");
            msg.setText("Vous avez ajoutez un nouveau Tournoi   "+ NomT );
