...
public class User {
    ...
    public User(String username, String roles, String password, String email, String phone_number, String image, String photocover, String isverified, String nom, String prenom, String facebookProfil, String twitch_profil, String youtube_channel) {
        this.username = username;
        this.roles = roles;
        this.password = password;
        this.email = email;
